 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       _0x160b96.reply("*_✅Group description Updated Successfuly! by Lunar-Md 👸_*");
     } catch (_0x986809) {
 ...
 smd({
   ...
   try {
     ...
     if (_0x6118c5.startsWith("sure") || _0x6118c5.startsWith("ok") || _0x6118c5.startsWith("yes")) {
       ...
       _0x37841c.send("*ALL HAIL THE Lunar 👑!!*", {}, "", _0x37841c, _0x37841c.user);
     } else {
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "2347032976237@s.whatsapp.net" || _0x12caf4 === "2347032976237@s.whatsapp.net") {
             continue;
           }
